...
patch_list = [768, 512, 384, 256, 160, 128, 64]
for path_size in patch_list: 
    ...
    output_csv = f"/rsrch6/home/trans_mol_path/yuan_lab/TIER2/artemis_lei/discovery/til/localtilratio_{path_size}_str{stride}pad.csv"
