...
from predict_tme_CNN_k8 import generate_tme
...
#patch_stride=args.patch_size*0.5 #for segformer
...
generate_tme(datapath=args.data_dir, save_dir=args.save_dir, file_pattern=args.file_name_pattern, color_norm=args.color_norm, nfile=args.nfile,
            patch_size=args.patch_size, patch_stride=args.patch_size*0.5, input_size=args.input_size, nClass=args.nClass)
