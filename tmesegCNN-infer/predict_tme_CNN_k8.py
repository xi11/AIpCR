...
def generate_tme(datapath, save_dir, file_pattern='*.svs', nfile=0, patch_size=384, patch_stride=192, input_size=384, nClass=2, color_norm=True):
    model = load_model('/rsrch5/home/trans_mol_path/xpan7/tmesegK8/code/model/TMElung_artemisTcgaAll_div12v2_K8_img768x20penmark.h5', custom_objects={'tf': tf}, compile=False)
