...
output_csv = '/rsrch6/home/trans_mol_path/yuan_lab/TIER2/artemis_lei/discovery/til/localtil_64_str32pad.csv'
...
for file_name in sorted(os.listdir(image_dir)):
    if file_name.endswith('.png'):
        ...
        average_density, average_density_non_zero = calculate_lymphocyte_density(image_path, csv_path, patch_size=64, stride=32)
        results.append({
            'ID': file_name[:-20],
