...
def supres50_a(img_a):
    ...
    x = conv_block_str(x, 3, [16, 16, 64], stage=2, block='ac')
...
def supres50_b(img_b, Sa1):
    ...
    x = conv_block_str(x, 3, [16, 16, 64], stage=2, block='bc')
    ...
    x = conv_block_str(x, 3, [32, 32, 128], stage=3, block='bd')
...
def supres50_c(img_c, Sb1):
    ...
    x = conv_block_str(x, 3, [16, 16, 64], stage=2, block='cc')
    #x = one_side_pad(x)
    ...
    x = conv_block_str(x, 3, [32, 32, 128], stage=3, block='cd')
    ...
    x = conv_block_str(x, 3, [64, 64, 256], stage=4, block='cf')
