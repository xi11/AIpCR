...
model=load_model(r'TMElung_artemis_tcga_sum12_e50_sCE_img1536x10.h5', custom_objects={'tf': tf}, compile=False)
#model.summary()
save_dir = r'Z:\TIER2\barrett\tmeseg_lung_artemis_tcga_sum12_e50_sCEx10\MDA\flow\mask_cws'
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
    #os.makedirs(os.path.join(save_dir, 'mask_cws'))

datapath = r'Z:\TIER2\barrett\til\MDA\flow\1_cws_tiling'
