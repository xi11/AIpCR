...
def run(opts_in):
    ...
    files = sorted(glob(os.path.join(data_path, 'TCGA*')))
    for file in files:
...
if __name__ == '__main__':
    opts = {
        'save_path': pathlib.Path('/Volumes/xpan7/tmesegK8/patchx10x20_bcss_wsss4luad/lung1024_512/patch256x10_512'),
        'data_path': pathlib.Path('/Volumes/xpan7/tmesegK8/patchx10x20_bcss_wsss4luad/lung1024_512/image'),  #main_file_path -> img_path
        'label_path': pathlib.Path('/Volumes/xpan7/tmesegK8/patchx10x20_bcss_wsss4luad/lung1024_512/mask9'),
