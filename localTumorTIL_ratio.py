...
results = []
patch_size = 64 #The diameter of a core is around 1 mm
stride = 64

output_csv = f'/rsrch6/home/trans_mol_path/yuan_lab/TIER2/artemis_lei/discovery/til/localTIL/localtilTumorratio_{patch_size}_str{stride}pad.csv'
