...
parent_dir = "/rsrch6/home/trans_mol_path/yuan_lab/TIER1/artemis_lei/IMPRESS_HER2/HE"
files = sorted(glob(os.path.join(parent_dir, '*.svs')))[12:15]
out_base = Path("/rsrch6/home/trans_mol_path/yuan_lab/TIER2/artemis_lei/IMPRESS_HER2/hovernet")
